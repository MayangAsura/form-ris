                  ...
                  <div className="flex flex-wrap -mx-3 mb-4">
                    <div className="w-full px-3">
                      ...
                      <div className="mt-2 grid grid-cols-1">
                          <select id="media" name="school_id" value={school_id} onChange={(e) => setSchoolId(e.target.value)} {...register('school_id')} autoComplete="school_id" className="col-start-1 row-start-1 w-full appearance-none rounded-md bg-white py-1.5 pr-8 pl-3 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" required>
