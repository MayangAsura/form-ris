                ...
                <form>
                  <div className="flex flex-wrap -mx-3 mb-4">
                    <div className="w-full px-3">
                      <label className="block text-gray-800 text-sm font-medium mb-1" htmlFor="full_name">Nama Lengkap <span className="text-red-600">*</span></label>
                  ...
                  <div className="flex flex-wrap -mx-3 mb-4">
                    <div className="w-full px-3">
                      <label className="block text-gray-800 text-sm font-medium mb-1" htmlFor="jenis_kelamin">Jenis Kelamin <span className="text-red-600">*</span></label>
                  ...
                  <div className="flex flex-wrap -mx-3 mb-4">
                    <div className="w-full px-3">
                      <label className="block text-gray-800 text-sm font-medium mb-1" htmlFor="phone_number">No. WhatsApp <span className="text-red-600">*</span></label>
                  ...
                  <div className="flex flex-wrap -mx-3 mb-4">
                    <div className="w-full px-3">
                      ...
                      <input id="email" name='email' type="email" onChange={(e) => setEmail(e.target.value)} value={email} className="form-input w-full text-gray-800" placeholder="Enter your email address" required />
                    </div>
                  </div>
                  <div className="flex flex-wrap -mx-3 mb-4">
                    <div className="w-full px-3">
                      <label className="block text-gray-800 text-sm font-medium mb-1" htmlFor="school">Jenjang <span className="text-red-600">*</span></label>
                  ...
                  <div className="flex flex-wrap -mx-3 mb-4">
                    <div className="w-full px-3">
                      <label className="block text-gray-800 text-sm font-medium mb-1" htmlFor="confirm_password">Konfimasi Password <span className="text-red-600">*</span></label>
                  ...
                  {/* <div className="sm:col-span-4">
                                        <label htmlFor="father_academic" className="block text-sm/6 font-medium text-gray-900">Darimana Bapak/Ibu Mendapatkan Informasi tentang Rabbaanii Islamic School?</label>
                                        <div className="mt-2 grid grid-cols-1">
                                            ...
                                            <option>Orang Tua Siswa Lain </option>
                                            <option>Saudara </option>
                                            <option>Karyawan Thursina </option>
                                            <option>Brosur</option>
                                            <option>Website Thursina </option>
                                            <option>Instagram </option>
                                            <option>Facebook </option>
                                            <option>Youtube </option>
                                            <option>Majalah </option>
                                            <option>Koran / pemberitaan online</option>
                                            <option>Tiktok  </option>
                                            <option>Rekomendasi mesin pencarian internet   </option>
                  ...
                  <div className="text-sm text-gray-500 text-center mt-3">
                      *Pastikan data yang diisi sudah benar. Bila ada pertanyaan seputar Kami, silahkan dapat membuka halaman <a href="">FAQ</a> atau menghubungi CS yang tertera di Web. Baarakallahu fiikum.
