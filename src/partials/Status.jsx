              ...
              <div className="py-12 md:py-12">
                <div className="max-w-sm bg-white shadow-2xl rounded-lg border border-dashed border-gray-900/25 overflow-hidden">
                  ...
                  <div className="mt-2 pb-20 flex justify-center rounded-lg">
                      ...
                      <div className=" text-sm/6 text-gray-600 p-5">
                        ...
                        <span className="inline-flex items-center rounded-md bg-green-50 px-2 py-1 mt-2 mb-4 text-sm font-medium text-green-700 ring-1 ring-inset ring-green-600/20">
                          SELESAI
                        </span>
                          {/* <TiInputCheckedOutline  size={512} className='items-center'/> */}
                          {/* <p className="pb-1">Status Pembayaran</p> */}
                          <p className="pb-1">Pengisian formulir telah selesei. Informasi selanjutnya dapat dilihat melalui pengumuman. Ananda dapat melakukan pembaruan data sebelum tanggal berakhir pendaftaran.</p>

                          <button type="submit" className='btn w-full block btn-sm mt-5 text-sm text-gray-200 bg-green-900 hover:bg-gray-800'
                                                  // onClick={() => {
