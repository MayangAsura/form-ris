                  ...
                  <div className="mt-2 pb-20 flex justify-center rounded-lg">
                      ...
                      <div className=" text-sm/6 text-gray-600">
                        ...
                        <span className="inline-flex items-center rounded-md bg-green-50 px-2 py-1 text-xs font-medium text-green-700 ring-1 ring-inset ring-green-600/20">
                          ...
                          <p className="pb-1">Pengisian Formulir telah lengkap. Informasi selanjutnya dapat dilihat melalui pengumuman. Ananda dapat melakukan pembaruan data sebelum tanggal berakhir pendaftaran.</p>
                          {/* <label
                          htmlFor="file-upload"
