            ...
            >
                ...
                <div className="flex flex-col justify-center items-center">
                  ...
                  <div className="flex flex-col mt-3 text-center items-center justify-center sm:ml-4 sm:mt-0 sm:text-center">
                    {props.dataModal.title && (
                      <DialogTitle as="h4" className="text-base text-center font-semibold text-gray-900">
                        {props.dataModal.title}
                      </DialogTitle>
                    )}
              ...
              <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-col sm:px-6">
                <button
                    ...
                    className="inline-flex w-10 justify-center rounded-md bg-black px-3 py-2 my-2 text-sm font-semibold text-white shadow-sm hover:bg-gray-800 sm:w-auto"
                  >
                    Tutup
                  </button>
